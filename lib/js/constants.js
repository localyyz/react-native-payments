...
export const BILLING_CONTACT_CHANGE_EVENT = 'billingcontactchange';
export const INTERNAL_BILLING_CONTACT_CHANGE_EVENT = `${MODULE_SCOPING}:on${BILLING_CONTACT_CHANGE_EVENT}`;
